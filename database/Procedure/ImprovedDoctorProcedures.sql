...
END$$
GRANT EXECUTE ON PROCEDURE hospital_management_system.GetPatientsInfo TO 'Doctors'@'IP'$$
...
BEGIN
    ...
    COMMIT;
END$$
GRANT EXECUTE ON PROCEDURE hospital_management_system.AddAllergiesToPatients TO 'Doctors'@'IP'$$
...
BEGIN
    ...
    COMMIT;
END$$
GRANT EXECUTE ON PROCEDURE hospital_management_system.AddNewDiagnosis TO 'Doctors'@'IP'$$
...
BEGIN
    ...
    COMMIT;
END$$
GRANT EXECUTE ON PROCEDURE hospital_management_system.AddNewPrescription TO 'Doctors'@'IP'$$
...
BEGIN
    ...
    COMMIT;
END$$
GRANT EXECUTE ON PROCEDURE hospital_management_system.OrderTest TO 'Doctors'@'IP'$$
...
END$$
GRANT EXECUTE ON PROCEDURE hospital_management_system.GetAllDrugs TO 'Doctors'@'IP'$$
